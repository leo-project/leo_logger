...
-define(log(_ModLevel,_ModuleString,_FuncName,_Line,_Format,_Message),
        begin
            leo_logger_api:_ModLevel(#message_log{module   = _ModuleString,
                                                             function = _FuncName,
                                                             line     = _Line,
                                                             format   = _Format,
                                                             message  = _Message})
...
-define(fatal(_Func,_Format,_Message),
        leo_logger_api:fatal(#message_log{level    = ?LOG_LEVEL_FATAL,
...
-define(error(_Func,_Format,_Message),
        leo_logger_api:error(#message_log{level    = ?LOG_LEVEL_ERROR,
                                                     module   = ?MODULE_STRING,
                                                     function = _Func,
                                                     line     = ?LINE,
                                                     format   = _Format,
...
-define(warn(_Func,_Format,_Message),
        leo_logger_api:warn(#message_log{level    = ?LOG_LEVEL_WARN,
                                                    module   = ?MODULE_STRING,
                                                    function = _Func,
                                                    line     = ?LINE,
                                                    format   = _Format,
...
-define(info(_Func,_Format,_Message),
        leo_logger_api:info(#message_log{level    = ?LOG_LEVEL_INFO,
                                                    module   = ?MODULE_STRING,
                                                    function = _Func,
                                                    line     = ?LINE,
                                                    format   = _Format,
...
-define(debug(_Func,_Format,_Message),
        leo_logger_api:debug(#message_log{level    = ?LOG_LEVEL_DEBUG,
                                                     module   = ?MODULE_STRING,
                                                     function = _Func,
                                                     line     = ?LINE,
                                                     format   = _Format,
